"""
Amazon Purchase Analysis - AWS EMR Optimized Version
=====================================================

This script is optimized for AWS EMR with Spark 2.4.x
Reads data from S3, processes with Spark, and writes results back to S3.

Usage:
    spark-submit \
        --deploy-mode cluster \
        s3://your-bucket/scripts/amazon_purchase_analysis_emr.py \
...
Author: Corrected Version for EMR
Date: 2025-10-20
Spark Version: 2.4.x (EMR 5.36.0 or 6.x)
"""
...
def main():
    ...
    try:
        logger.info("Initializing Spark Session for EMR")
        spark = SparkSession.builder \
            .appName("Amazon Purchase Analysis - EMR") \
